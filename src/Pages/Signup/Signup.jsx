...
const Signup = () => {
    ...
    <div className="flex-1 bg-white rounded-lg text-center hidden lg:flex">
            <div className="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat bg-[url('https://i.ibb.co/60x2DBm/signup.png')]">
            </div>
        </div>
        ...
        <div className="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
            ...
            <div className="mt-2 flex flex-col items-center">
                <div className="w-full flex-1 mt-8">
                    ...
                    <div className="mb-9 mt-4 border-b text-center w-4/5 mx-auto">
                        <div
                    ...
                    <div className="mx-auto max-w-xs">
                        ...
                        <input {...register("name", { required: true })}  className="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                            type="text" placeholder="Name" />
                        {errors.name && <span className="text-red-500 mt-1 ml-1">Name is required!!</span>}
 

                        <input {...register("contact", { required: true })}  className="w-full mt-5 px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                            type="text" placeholder="Contact" />
                        {errors.contact && <span className="text-red-500 mt-1 ml-1">Contact is required!!</span>}

                      

                        <input {...register("email", { required: true })}  className="w-full  mt-5 px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white"
                        ...
                        <p className="mt-6 text-xs text-gray-600 text-center">
                            ...
                            <Link to="/login" className="border-b text-blue-600  ml-1 border-gray-500 border-dotted">
                                login
                            </Link>
                        </p>
                    </div>
