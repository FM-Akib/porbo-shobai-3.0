...
const Dashboard = () => {
    return (
        ...
        <div className="grid grid-cols-12">
            ...
            <div className="min-h-screen bg-amber-300 col-span-1 rounded-md">

            <div aria-label="side bar" aria-orientation="vertical"
            className="min-h-full flex-none rounded-md flex flex-col items-center text-center bg-teal-900 text-gray-400 border-r">
